...
module.exports = {
    ...
    play (message) {
        ...
        try {
            ...
            if (songname.includes('youtube.com')) {
                ...
                // eventually this will be the html parse
    ...
    async playNextSong(voiceChannel) {
        try {
            ...
            if (channelInfo.nowPlaying === null) {
                channelInfo.nowPlaying = resource
            }
        }
        catch (error) {
            //console.error(error)
    ...
    makeMessageButtons(message) {
        ...
        embed.setAuthor(message.member.nickname || message.author.username, message.author.avatarURL());
        embed.setDescription('Now Playing ' + channelInfo.nowPlaying);
